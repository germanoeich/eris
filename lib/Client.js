    ...
    */
    ...
    enableGuilds(guilds) {
        if (typeof guilds === 'string') {
            ...
            this.enabledGuilds = new Set([...this.enabledGuilds.values()].concat(guilds))
        }
    }

    uncacheGuild(guildID) {
        this.uncachedGuilds.set(guildID, {
            id: guildID,
            uncached: true,
        });
        if (this.guilds && this.guilds.has(guildID)) {
